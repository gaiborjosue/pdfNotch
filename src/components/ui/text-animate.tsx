...
const TextAnimate: FC<Props> = ({
  ...
  if (type === "rollIn" || type === "whipIn") {
    return (
      <h2 className="mt-10 text-3xl font-black text-black dark:text-neutral-100 py-5 pb-8 px-8 md:text-5xl flex flex-wrap justify-center gap-x-[0.25em]">
  ...
  return (
    <motion.h2
      style={{ display: "flex", flexWrap: "wrap", overflow: "visible", justifyContent: "center", gap: "0.05em" }}
      role="heading"
      variants={container}
      initial="hidden"
      animate="visible"
